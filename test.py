...
from pifoam.initial.p import set_uniformPressure
...
y_num = 100
z_num = 1
boundary_types = {"north":"wall", "top": "empty", "bottom": "empty", "east": "patch", "west": "patch", "south": "wall"}
...
pifoam.utils.move_STL(case_dir, "./sample.stl")
run_blockMeshDict(
    case_dir,
    scale=1,
    x_range=x_range,
...
write_snappyHexMeshDict(case_dir, "sample.stl", (29.9, 0.1, 5.51))
...
# set_uniformPressure(case_dir, boundaryNames=["north", "south", "east", "west", "top", "bottom"], boundaryConditions=[{"type":"noSlip"} for i in range(6)])
